...
class AttendanceFilter(django_filters.FilterSet):
    ...
    class Meta:
        model = Attendance
        fields = ['employee_id','author','status','date']  # Add more fields if needed
...
class LeavesFilter(django_filters.FilterSet):
    ...
    class Meta:
        model = Leaves
        fields = ['employee_id','author','status','from_date','to_date']  # Add more fields if needed
...
class SalariesFilter(django_filters.FilterSet):
    ...
    class Meta:
        model = Salaries
        fields = ['employee_id','author','status','date','salary']  # Add more fields if needed